...
# Next Steps for ndx-nirs Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-nirs directory.
...
`spec/ndx-nirs.namespace.yaml` and
`spec/ndx-nirs.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-nirs
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/sumner15,dsleiter,ribeirojose/ndx-nirs/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-nirs/0.1.0
...
`staged-extensions/ndx-nirs`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-nirs
    ```

13. Edit `staged-extensions/ndx-nirs/ndx-meta.yaml`
...
name: ndx-nirs
version: 0.1.0
src: https://github.com/sumner15,dsleiter,ribeirojose/ndx-nirs
pip: https://pypi.org/project/ndx-nirs/
license: BSD 3-Clause
maintainers: 
  - sumner15,dsleiter,ribeirojose
```

14. Edit `staged-extensions/ndx-nirs/README.md`
to add information about your extension. You may copy it from
`ndx-nirs/README.md`.

```bash
cp ndx-nirs/README.md staged-extensions/ndx-nirs/README.md
```
...
git add ndx-nirs
git commit -m "Add new catalog entry for ndx-nirs" .
git push
```
...
ndx-nirs-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-nirs GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-nirs-feedstock repository on GitHub.
